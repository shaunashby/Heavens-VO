...
package VO::Table::API::INFO;

sub name() { return shift->{'name'}; }
sub value() { return shift->{'value'}; }

package VO::Table::API::TABLE;
...
package VO::Table::API::DESCRIPTION;
...
package VO::Table::API::TABLEDATA;
